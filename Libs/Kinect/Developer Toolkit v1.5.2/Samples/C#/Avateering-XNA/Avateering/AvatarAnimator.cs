...
namespace Microsoft.Samples.Kinect.Avateering
{
    ...
    public class AvatarAnimator : DrawableGameComponent
    {
            ...
            : base(game)
        {
            ...
            this.kinectLineSkeletonWorldOffsetMatrix = Matrix.CreateTranslation(SkeletonTranslationScaleFactor.X, 0.75f * SkeletonTranslationScaleFactor.Y, 0);
            ...
            this.boneOrientationConstraints = new BoneOrientationConstraints(game, SkeletonTranslationScaleFactor);
